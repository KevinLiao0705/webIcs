...
//==========================================================
    public Root(HashMap<String, String> requestPara, String realPath) {
        int i;
        String[] strA;
        if (GB.firstCallRoot_f == 1) {
            return;
        }
        GB.firstCallRoot_f = 1;
        strA = realPath.split("/");
        String srcPath = "";
        ...
        wstr+="\nlog4j.appender.fileout.File="+GB.webRootPath+"/webIcs.log";
        ...
        //PropertyConfigurator.configure(GB.webRootPath + "log4j.properties");
        PropertyConfigurator.configure(GB.webRootPath + "/webIcs.properties");
        //=============================================
        ...
        //===============================================
        Root.log(1, "*******************************");
        Root.log(1, "Web Base Program Start");
        //===============================================
        GB.init();
        GB.paraMap.clear();
        Lib.readSetdataFileToPara(GB.webRootPath + "setdata.xml", GB.paraMap);
    ...
    //logLevel 3 error
    //logLevel 4 falut
    public static void log(int logLevel, String mes) {
        if (logLevel == 0) {
            if (GB.logDebug_f == 0) {
    ...
    static Connection dbConnect(Connection con) {
        ...
        try {
            ...
            Root.log(4, "Connect Database Error !!!");
        }
        return null;
    }
